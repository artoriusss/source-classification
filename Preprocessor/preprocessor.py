...
if not os.path.exists(FASTTEXT_PATH):
    os.system(f"wget https://dl.fbaipublicfiles.com/fasttext/supervised-models/{FASTTEXT_PATH}")
...
class Preprocessor:
    ...
    #     prediction = self.model.predict(text, k=1)  # Predict the top 1 language
    #     return prediction[0][0].replace("__label__", "")  # Extract the language label
